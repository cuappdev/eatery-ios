...
class EateriesGridViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, MenuFavoriteDelegate, UIViewControllerPreviewingDelegate {
