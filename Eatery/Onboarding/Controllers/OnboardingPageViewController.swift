...
class OnboardingPageViewController: UIPageViewController {
    ...
    override func viewDidLoad() {
        ...
        self.pageControl.frame = CGRect(x: 0, y: 0, width: 0, height: 0)
        self.pageControl.currentPageIndicatorTintColor = .white
        self.pageControl.pageIndicatorTintColor = UIColor(displayP3Red: 1, green: 1, blue: 1, alpha: 0.30)
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.baseline.equalToSuperview().offset(-35)
        }
    }
